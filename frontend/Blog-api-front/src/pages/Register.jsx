            ...
            <div className="relative z-10 text-center">
                ...
                <div className="bg-white rounded-md shadow-md p-6 w-[320px] text-left">
                    ...
                    <div className="mb-4 flex gap-1 items-center">
                        <CiUser className=" w-6 h-6  text-olive-600"/>
                        <input
                            type="text"
                            placeholder="nom"
                            value={name}
                    ...
                    <div className="mb-4 flex gap-1 items-center">
                        <TbLockPassword className="w-6 h-6 text-olive-600" />
                        <input
                            type="password"
                    ...
                    <button
                        ...
                        disabled={!isChecked}
                        className={`w-full py-2 rounded-md text-white ${isChecked ? "bg-blue-600" : "bg-gray-400 cursor-not-allowed"
                            }`}
                    >
                        s'inscrire
                    </button>
